...
var Link = function (_React$Component) {
	...
	function Link() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Link.__proto__ || Object.getPrototypeOf(Link)).call.apply(_ref, [this].concat(args))), _this), _this.dateStyle = function () {
			return {
				color: '#888',
				fontSize: '0.7em',
				marginRight: '0.5.em'
...
var _CreateLinkMutation = __webpack_require__(/*! ../mutations/CreateLinkMutation */ "./src/mutations/CreateLinkMutation.js");
...
/***/ "./src/mutations/CreateLinkMutation.js":
/*!*********************************************!*\
  !*** ./src/mutations/CreateLinkMutation.js ***!
  \*********************************************/
/*! no static exports found */
...
var CreateLinkMutation = function (_Relay$Mutation) {
	...
	_createClass(CreateLinkMutation, [{
		...
		value: function getMutation() {
			return function () {
				throw new Error('Relay transform error ``Cannot read property \'toString\' of null`` in file `/Users/ashotpahlevanyan/MyProjects/rogerreactgraphrelay/src/mutations/CreateLinkMutation.js`. Try updating your GraphQL schema if an argument/field/type was recently added.');
			}();
		}
	}, {
		key: 'getVariables',
		...
		value: function getFatQuery() {
			return function () {
				throw new Error('GraphQL validation error ``Unknown type "CreateLinkPayload".`` in file `/Users/ashotpahlevanyan/MyProjects/rogerreactgraphrelay/src/mutations/CreateLinkMutation.js`. Try updating your GraphQL schema if an argument/field/type was recently added.');
			}();
		}
	}, {
		key: 'getConfigs',
